...
class TaskPolicy
{
    ...
    public function create(User $user): Response
    {
        ...
        ? Response::allow()
        : Response::deny("You don't have permission to add task");
    }
    ...
    {
        return $user->id === $task->assigned_by || $user->role ==='admin' || $user->role ==='project_manager'
        ? Response::allow()
    ...
    {
        return $user->id === $task->assigned_by || $user->role === ($user->role ==='admin') || $user->role ==='project_manager'
        ? Response::allow()
